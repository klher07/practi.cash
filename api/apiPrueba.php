...
$cone = pg_connect("host=localhost port=5432 dbname=baseprueba password=practicash@2019 user=pabloreyes");
//$cone = pg_connect("host=localhost port=5432 dbname=practic password=123456 user=postgres");

/*
PARAMETROS CUENTA PAUL

sid
AC3e407638f2d7344059d07a9ba16216d8

token
4643de6f651afd944fbd1ace22ce07c0
...
CUENTA ESPOSA
ACCOUNT SID  
ACb529b562ad695b3e50e78f7b7751e229
 token
48f616fb79f5dd38dee813192ea1d013
...
//-----------------------------------------------------------------------
//AQUI CONFIRMMO SI EL NUMERO DE TLF ES DE PABLO

  		if($numero_suscribir1 == '5930968081660' || $numero_suscribir1 == '5930968081660')
  		{
			$sid1 = 'ACe204ca84c384c61b2bd93e34b2c3ff8b';
			$token1 = 'f092612038e50ee2a558b1695e273d5d';
			$telefono_twilio = '+14245433110';  			
  		}
//AQUI CONFIRMMO SI EL NUMERO DE TLF ES DE PAUL
  		if($numero_suscribir1 == '593995397038')
  		{
			$sid1 = 'AC3e407638f2d7344059d07a9ba16216d8';
			$token1 = '4643de6f651afd944fbd1ace22ce07c0';
			$telefono_twilio = '+16506459834';  			
  		}

//AQUI CONFIRMMO SI EL NUMERO DE TLF ES DE ESPOSA
  		if($numero_suscribir1 == '593984573088')
  		{
			$sid1 = 'ACb529b562ad695b3e50e78f7b7751e229';
			$token1 = '48f616fb79f5dd38dee813192ea1d013';
			$telefono_twilio = '+13344544302';  			
  		}
//-----------------------------------------------------------------------------
...
//aqui registra en transaccion que tiene un saldo de 0
			...
			$sql_registro_t ="INSERT INTO transacciones(fecha,id_cliente,valor,descripcion,observacion,id_tarjeta, stripe_id,transaccion_id) VALUES('$f_tran','$id_cliente_n',50,'primer deposito','bien',1,'1','1')";
		...
		//aqui valida las extensiones y hace el update
				  if($imagen['type'] == "image/jpg" OR $imagen['type'] == "image/jpeg" OR $imagen['type'] == "image/png")
				  {
				    ...
				    {       
					  ...
					  $rutaT = $nuevo_nombre.".jpg";
				      $sql ="UPDATE clientes SET imagen ='$rutaT' WHERE id='$id_cli'";
